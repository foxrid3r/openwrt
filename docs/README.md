...
| Determine whether an installer migration is required | [Determine your upgrade path](getting-started/flashing-e8450.md#determine-your-upgrade-path) |
| Install this image on an E8450 using the current UBI layout | [Install the final firmware](getting-started/flashing-e8450.md#install-the-final-firmware) |
